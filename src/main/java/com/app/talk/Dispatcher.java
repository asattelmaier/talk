...
public class Dispatcher implements Runnable {
    ...
    private void listen() throws IOException, ClassNotFoundException {
        ...
        while (acceptClients) {
            try {
                ...
                Communicator communicator = communicatorFactory.createCommunicator(client,
                        CommunicatorFactory.SERVER);
                Dispatcher.addClient(communicator);
                communicator.send(new SetContextCommand(communicator.context));
                communicator.start();
     ...
     * @param message Clients text message.
     */
